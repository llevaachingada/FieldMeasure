...
export const TOOL_DEFS: readonly ToolDef[] = [
  ...
  { id: 'angle', group: 2, label: STRINGS.tool.angle, Icon: ToolAngleIcon, implemented: true },
  { id: 'line', group: 3, label: STRINGS.tool.line, Icon: ToolLineIcon, implemented: true },
  { id: 'arrow', group: 3, label: STRINGS.tool.arrowLeader, Icon: ToolArrowIcon, implemented: true },
  { id: 'rect', group: 3, label: STRINGS.tool.rectangle, Icon: ToolRectIcon, implemented: true },
  { id: 'ellipse', group: 3, label: STRINGS.tool.ellipse, Icon: ToolEllipseIcon, implemented: true },
  { id: 'polygon', group: 3, label: STRINGS.tool.polygon, Icon: ToolPolygonIcon, implemented: true },
